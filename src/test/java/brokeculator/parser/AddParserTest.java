...
public class AddParserTest {
    ...
    void parseInput_stringCorrectFormat_addCommand() {
        String input = "add /n test1 /d 04-11-2023 /a 10 /c category1";
    ...
    void parseInput_stringNoCategory_addCommand() {
        String input = "add /n test1 /d 04-11-2023 /a 10";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(AddCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringEmptyCategory_addCommand() {
        String input = "add /n test1 /d 04-11-2023 /a 10 /c";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(AddCommand.class, resultCommand);
    }
    @Test
    ...
    void parseInput_stringEmptyAmount_invalidCommand() {
        String input = "add /n test1 /d 04-11-2023 /a /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringInvalidDateOptionFormat_invalidCommand() {
        String input = "add /n test1/d04-11-2023 /a 10 /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringInvalidDateFormat_invalidCommand() {
        String input = "add /n test1 /d 4-11-2023 /a 10 /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringInvalidAmountOptionFormat_invalidCommand() {
        String input = "add /n test1 /d 04-11-2023 /a10 /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringInvalidCategoryOptionFormat_invalidCommand() {
        String input = "add /n test1 /d 04-11-2023 /a 10 /ccategory1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringInvalidNameOptionFormat_invalidCommand() {
        String input = "add /ntest1 /d 04-11-2023 /a 10 /c category1 /c category2";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringAmountExtraDecimal_invalidCommand() {
        String input = "add /n test1 /d 04-11-2023 /a 10.0.0 /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringAmountInfinity_invalidCommand() {
        String input = "add /n test1 /d 04-11-2023 /a Infinity /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    ...
    void parseInput_stringAmountNan_invalidCommand() {
        String input = "add /n test1 /d 04-11-2023 /a -10.0 /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(InvalidCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringWrongAmountOptionOrder_addCommand() {
        String input = "add /n test1 /a 10 /d 04-11-2023 /c category1";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(AddCommand.class, resultCommand);
    }
    @Test
    void parseInput_stringWrongCategoryOptionOrder_addCommand() {
        String input = "add /c category1 /n test1 /a 10 /d 04-11-2023 ";
        Command resultCommand = AddParser.parseInput(input);
        assertInstanceOf(AddCommand.class, resultCommand);
    }
    @Test
